...
export const PRODUCT_PLACEHOLDER_MAP: Record<string, string> = {
  ...
  'red-bricks-a-plus': '/assets/product-red-bricks-a-plus.png',
  'red-bricks-b-plus': '/assets/product-red-bricks-b-plus.png',
  'grey-flash-cement-bricks': '/assets/product-grey-flash-cement-bricks.png',
  'grey-ash-bricks-a': '/assets/product-grey-ash-bricks-a-plus.png',
  'grey-ash-bricks-a-plus': '/assets/product-grey-ash-bricks-a-plus.png',
  'grey-ash-bricks-b-plus': '/assets/product-grey-ash-bricks-b-plus.png',
